...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiviansPieShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("LiviansPieShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("LiviansPieShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("LiviansPieShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("LiviansPieShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("LiviansPieShop.Models.OrderDetail", b =>
                {
                    b.HasOne("LiviansPieShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LiviansPieShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LiviansPieShop.Models.Pie", b =>
                {
                    b.HasOne("LiviansPieShop.Models.Category", "Category")
                        .WithMany("Pies")
